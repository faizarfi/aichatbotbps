...
<div class="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-8">
    ...
    <div class="bg-gradient-to-br from-[#04325e] via-[#004b87] to-[#013a63] text-white rounded-3xl p-6 sm:p-8 border-b-4 border-[#f7941d] shadow-md relative overflow-hidden">
