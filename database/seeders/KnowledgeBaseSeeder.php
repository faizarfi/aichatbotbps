            ...
            [
                ...
                'articles' => [
                    [
                        ...
                        'answer' => "Masyarakat, akademisi, mahasiswa, dan instansi dapat memperoleh data statistik BPS Kabupaten Karanganyar melalui kanal resmi:\n1. Website Resmi: Kunjungi https://karanganyarkab.bps.go.id untuk mengunduh publikasi buku statistik (PDF/Excel) secara 100% GRATIS.\n2. Portal PST Online Nasional: Akses https://pst.bps.go.id untuk layanan permohonan data dan konsultasi secara daring.\n3. Datang Langsung ke PST: Kunjungi Pelayanan Statistik Terpadu di Kantor BPS Kabupaten Karanganyar pada jam kerja.\n4. Email Resmi: Kirimkan surat permohonan ke bps3313@bps.go.id dengan menyertakan identitas serta rincian data/penelitian yang dibutuhkan.",
            ...
            [
                ...
                'articles' => [
                    ...
                    [
                        ...
                        'source_title' => 'BPS Karanganyar Dalam Angka 2026',
                        'source_url' => 'https://karanganyarkab.bps.go.id',
                    ],
                    [
                        ...
                        'source_title' => 'Berita Resmi Statistik Kemiskinan BPS Karanganyar 2026',
                        'source_url' => 'https://karanganyarkab.bps.go.id',
                    ],
                    [
                        ...
                        'source_title' => 'Indikator Pembangunan Manusia BPS Karanganyar 2026',
                        'source_url' => 'https://karanganyarkab.bps.go.id',
                    ],
                    [
                        ...
                        'source_title' => 'Publikasi PDRB BPS Kabupaten Karanganyar 2026',
                        'source_url' => 'https://karanganyarkab.bps.go.id',
                    ],
                    [
                        ...
                        'source_title' => 'Indikator Ketenagakerjaan BPS Karanganyar 2026',
                        'source_url' => 'https://karanganyarkab.bps.go.id',
                    ],
                    [
                        ...
                        'source_title' => 'Berita Resmi Statistik Inflasi BPS 2026',
                        'source_url' => 'https://karanganyarkab.bps.go.id',
                    ],
                    [
                        ...
                        'source_title' => 'Statistik Pertanian Tanaman Pangan BPS Karanganyar 2026',
                        'source_url' => 'https://karanganyarkab.bps.go.id',
                    ],
                    [
                        ...
                        'source_title' => 'Master Wilayah BPS Kabupaten Karanganyar 2026',
                        'source_url' => 'https://karanganyarkab.bps.go.id',
                    ],
                    [
                    ...
                    [
                        'title' => 'Penjelasan Desil Regsosek vs Bantuan Sosial (Kemensos/Dinsos)',
                        'question' => 'Mengapa saya tidak menerima bansos padahal disurvei BPS? Bagaimana cara mengecek desil?',
                        'answer' => "Badan Pusat Statistik (BPS) bertugas mengumpulkan data dasar sosial ekonomi masyarakat melalui pendataan lapangan (seperti Registrasi Sosial Ekonomi / Regsosek). BPS TIDAK MENENTUKAN siapa yang berhak menerima bantuan sosial dan TIDAK MENYALURKAN bansos.\n\nPenetapan penerima bansos, desil kesejahteraan, dan Data Terpadu Kesejahteraan Sosial (DTKS) adalah kewenangan Kementerian Sosial (Kemensos) dan Dinas Sosial. Silakan cek status bansos secara mandiri melalui website https://cekbansos.kemensos.go.id atau tanyakan kepada operator SIKS-NG di Kantor Desa/Kelurahan setempat.",
                        'keywords' => ['bansos', 'bantuan sosial', 'pkh', 'bpnt', 'dtks', 'desil', 'regsosek', 'kemensos', 'dinsos'],
                        'source_title' => 'Penjelasan Publikasi Regsosek BPS',
            ...
            [
                ...
                'articles' => [
                    [
                        ...
                        'source_title' => 'SOP Pengelolaan Pengaduan Masyarakat BPS 2026',
                        'source_url' => 'https://karanganyarkab.bps.go.id',
                    ],
                    [
